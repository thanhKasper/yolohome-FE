...
const SensorInfo = ({sensorInf, handleClick} : {sensorInf: SensorInfoType; handleClick: () => void}) => {
  return (
    <div className="bg-slate-200 p-4 rounded-lg cursor-pointer border-2 border-slate-300 hover:bg-slate-100" onClick={() => {handleClick()}}>
      <p>
